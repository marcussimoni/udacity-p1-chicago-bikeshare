...
# vamos contar quantos Male (Masculinos) 
...
input("Aperte Enter para continuar...")
# Agora que nós podemos contar os usuários, 
# qual gênero é mais prevalente?
# TAREFA 6
# TODO: Crie uma função que pegue o gênero mais popular, 
...
answer = "Alguns registros não possuiem a coluna gender preenchida"
...
input("Aperte Enter para continuar...")
# TAREFA 10
# Gênero é fácil porque nós temos apenas algumas opções. 
# E quanto a start_stations? Quantas opções ele tem?
